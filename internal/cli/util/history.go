...
// TotalRecordedRewardsByType
// Sums the total rewards of all types recorded during given round period
func (ch *ChainHistory) TotalRecordedRewardsByType(
	t *test.SystemTest,
	from, to int64,
	rewardTypes []model.Reward,
	includeProviders, includeDelegates bool,
) int64 {
