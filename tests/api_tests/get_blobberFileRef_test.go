...
func getBlobberFileRefRequest(url string, registeredsdkWallet *model.Wallet, allocationId string, refType string, clientSignature string, remotePath string) model.BlobberGetFileRefsRequest {
