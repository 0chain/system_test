...
func Test0BoxWallet(testSetup *testing.T) {
	...
	t.RunSequentially("Get wallet keys should work with wallet present", func(t *test.SystemTest) {
		...
		zboxWalletKeys, response, err := zboxClient.GetWalletKeys(t, firebaseToken.IdToken, csrfToken, zboxClient.DefaultPhoneNumber, zboxClient.DefaultAppType)
	...
	t.RunSequentially("Get wallet keys should not work with wrong phone number ", func(t *test.SystemTest) {
		teardown(t, firebaseToken.IdToken, zboxClient.DefaultPhoneNumber)
		csrfToken := createCsrfToken(t, zboxClient.DefaultPhoneNumber)
		_, _, err := zboxClient.GetWalletKeys(t, firebaseToken.IdToken, csrfToken, "+910123456789", zboxClient.DefaultAppType)
	...
	t.RunSequentially("Get wallet keys should return empty with wallet not present", func(t *test.SystemTest) {
		...
		_, response, _ := zboxClient.GetWalletKeys(t, firebaseToken.IdToken, csrfToken, zboxClient.DefaultPhoneNumber, zboxClient.DefaultAppType)
