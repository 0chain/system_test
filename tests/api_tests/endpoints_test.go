...
func v1SharderGetSCState(t *testing.T, sharderSCStateRequest model.SharderSCStateRequest, consensusCategoriser endpoint.ConsensusMetFunction) (*model.SharderSCStateResponse, *resty.Response, error) { //nolint
