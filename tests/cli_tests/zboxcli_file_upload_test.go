...
func TestUpload(testSetup *testing.T) {
	...
	t.RunWithTimeout("Resume upload 2 should work fine", 10*time.Minute, func(t *test.SystemTest) { // todo: this is slow, see https://0chain.slack.com/archives/G014PQ61WNT/p1669672933550459
		allocSize := int64(2 * GB)
		fileSize := int64(500 * MB)
	...
	t.RunWithTimeout("Resume upload 3 should work fine", 10*time.Minute, func(t *test.SystemTest) { // todo: this is slow, see https://0chain.slack.com/archives/G014PQ61WNT/p1669672933550459
		allocSize := int64(2 * GB)
		fileSize := int64(500 * MB)
	...
	t.RunWithTimeout("Resume upload 4 should work fine", 10*time.Minute, func(t *test.SystemTest) { // todo: this is slow, see https://0chain.slack.com/archives/G014PQ61WNT/p1669672933550459
		allocSize := int64(2 * GB)
		fileSize := int64(500 * MB)
	...
	t.RunWithTimeout("Resume upload 5 should work fine", 10*time.Minute, func(t *test.SystemTest) { // todo: this is slow, see https://0chain.slack.com/archives/G014PQ61WNT/p1669672933550459
		allocSize := int64(2 * GB)
		fileSize := int64(500 * MB)
