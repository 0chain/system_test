...
//func TestScenariosCommonUserFunctions(testSetup *testing.T) {
...
//func TestFileRename(testSetup *testing.T) { // nolint:gocyclo
//	t := test.NewSystemTest(testSetup)
//	t.SetRunAllTestsAsSmokeTest()
//
//	t.Parallel()
...
//func TestFileCopy(testSetup *testing.T) { // nolint:gocyclo
//	t := test.NewSystemTest(testSetup)
//	t.SetRunAllTestsAsSmokeTest()
//
