...
func TestMinerStake(testSetup *testing.T) {
	...
	t.Run("Staking tokens against valid miner with valid tokens should work", func(t *test.SystemTest) {
	...
	t.Run("Staking tokens against miner should return intrests to wallet", func(t *test.SystemTest) {
